...
<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  		...
  		<!-- SITE TITLE -->
		<title>Nama Sekolah - Read {{ $jquin->nama_ek }}</title>
		<x-lpcss></x-lpcss>
	</head>
							...
							<div class="col-md-12">
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb">
								    	...
								    	<li class="breadcrumb-item"><a href="{{ route('extrakurikuler') }}">Extrakurikuler</a></li>
								    	<li class="breadcrumb-item active" aria-current="page"> {{ $jquin->nama_ek }} </li>
								  	</ol>
								</nav>
							</div> 
							...
							<div class="col-lg-10 offset-lg-1">
								<div class="single-post-wrapper">
									...
									<div class="single-post-title mb-35 text-center">
										<!-- Post Title -->
										<h3 class="h3-md">{{ $jquin->nama_ek }}</h3>
