...
@section('title','Galeri Edit Data')
    ...
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <form action="{{ route('galeri.update', $jquin->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PATCH') }}
                    <div class="form-group">
                        <label for="judul">Judul</label>
                        <input type="text" maxlength="50" class="form-control" name="judul" id="judul" required="" placeholder="Masukkan Judul" value="{{ $jquin->judul }}">
                    </div>

                    <div class="form-group">
                        <label for="deskripsi">Deskripsi Singkat</label>
                        <input type="text" maxlength="191" class="form-control" name="deskripsi" id="deskripsi" placeholder="Masukkan Deskripsi" value="{{ $jquin->deskripsi }}">
                    </div>
