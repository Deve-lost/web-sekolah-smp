    ...
    <div class="col-lg-5">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="media">
                    <img class="d-flex mr-3 img-thumbnail thumb-lg" src="@if(auth()->user()->path != 'default.png'){{ asset('storage/'.auth()->user()->path) }} @else {{ asset('admin/images/users/default.png') }} @endif" alt="Foto Profil">
