...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Profil Sekolah</h4>
                <br>
                <div class="table-responsive">
                    <table id="datatable" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Str::limit($jquin->sub_kategori, 30, '...') }}
                            </td>
                            <td>
                                <a href="{{ route('profil-sekolah.edit', $jquin->id) }}" class="btn btn-sm btn-warning"><i class="ti-pencil"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
